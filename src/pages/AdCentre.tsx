            ...
            {boosts.map((boost) => (
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  ...
                  {boost.status === 'active' && boost.daysRemaining > 0 && (
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600">Days Remaining:</span>
                      <span className="font-medium text-green-600">{boost.daysRemaining} days</span>
                    </div>
                  )}
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{formatDate(boost.startDate)}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">End Date:</span>
                    <span className="font-medium text-gray-900">{formatDate(boost.endDate)}</span>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-gray-900">{formatDate(currentBoost.startDate)}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600">End Date</p>
                        <p className="font-medium text-gray-900">{formatDate(currentBoost.endDate)}</p>
                      </div>
                      {currentBoost.status === 'active' && currentBoost.daysRemaining > 0 && (
                        <div>
                          <p className="text-sm text-gray-600">Days Remaining</p>
                          <p className="font-medium text-green-600">{currentBoost.daysRemaining} days</p>
                        </div>
                      )}
                      {currentBoost.rejectionReason && (
                        <div className="col-span-2">
                          <p className="text-sm text-gray-600">Rejection Reason</p>
                          <p className="font-medium text-red-600">{currentBoost.rejectionReason}</p>
                        </div>
                      )}
                    </div>
                  </div>
