      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-gray-200 hover:-translate-y-0.5 transition-all duration-200 ease-out relative">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-500 mb-1">All Consultations</p>
            <p className="text-2xl font-bold text-gray-900">{formatNumber(totalConsultations)}</p>
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-gray-200 hover:-translate-y-0.5 transition-all duration-200 ease-out relative">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <p className="text-2xl font-bold text-gray-900">{formatNumber(completedConsultations)}</p>
      ...
      <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm hover:shadow-md hover:border-gray-200 hover:-translate-y-0.5 transition-all duration-200 ease-out relative">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            ...
            <p className="text-2xl font-bold text-gray-900">{formatNumber(serviceRequests)}</p>
